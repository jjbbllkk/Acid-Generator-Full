# Acid Generator - Design Requirements

Comprehensive design specification for reproducing the Acid Generator sequencer module. This document covers panel layout, visual design, widget placement, color palette, typography, pattern generation algorithm, and signal behavior.
...
- **Panel Size**: 20HP (101.6mm wide x 128.5mm tall)
...
|---------|------|--------|-------|----------|
| Module title "ACID GENERATOR" | 3.5px | Bold | `#1a1a1a` | Centered, y~7 |
...
src/
  ...
  AcidGen.cpp         Module + widgets (PatternDisplay, InfoDisplay, AcidGenWidget)
  Generator.hpp       Pattern generation engine, PRNG, scale data, voltage helpers
res/
  AcidGen.svg         Panel SVG (101.6mm x 128.5mm)
```
